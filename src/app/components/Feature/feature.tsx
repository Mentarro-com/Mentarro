...
//       >
//         <div className="h-96 lg:h-96 rounded-xl shadow-xl bg-gray-300 mt-14 border-black" style={{ backgroundImage: 'url(./about.webp)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
//       </animated.div>
//     </div>
//   );
// };
