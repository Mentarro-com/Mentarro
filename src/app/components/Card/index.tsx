  ...
  return (
    <div>
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <main className="h-full  px-[25px] py-[66px] relative overflow-hidden flex items-center justify-center border-black">
          <div className="relative z-10 max-w-[350px] max-h-[375px] ">
            ...
            <div className="bg-[#FFFFFF] flex flex-col items-center pb-[28px] pt-[56px]">
              <h1 className="font-bold text-[18px] mt-[10px]">{name}</h1>
